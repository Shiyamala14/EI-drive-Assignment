...
public class VirtualClassroomApp {
    ...
    private static void addClassroom() {
        String name = getLineInput("Create Your Classroom Name: ");
        System.out.println();
    ...
    private static void addStudent() {
        String className = getLineInput("Choose Your classroom name: ");
        System.out.println();
        String studentId = getLineInput("Create Your Student ID: ");
        System.out.println();
    ...
    private static void scheduleAssignment() {
        String className = getLineInput("Select classroom Name: ");
        System.out.println();
        String title = getLineInput("Give Assignment Title: ");
        System.out.println();
        String description = getLineInput("Give assignment description: ");
        System.out.println();
        Classroom classroom = manager.getClassroom(className);
    ...
    private static void listStudentsInClass() {
        ...
        if (students.isEmpty()) {
            ...
            System.out.println();
            System.out.println("Number of Students: " + c1);
            System.out.println("________________________________________");
        }
    }
    ...
    private static void listAssignmentsInClass() {
        ...
        if (assignments.isEmpty()) {
            ...
            System.out.println();
            System.out.println("Number of Assignments:" + a1);
            System.out.println("________________________________________");
        }
    }
}